...
其中 Arithmetic Intensity 定义为:

$$\text{AI} = \frac{\text{FLOPs}}{B_{HBM}}$$

与 Ridge Point $R = F_{MXU} / BW_{HBM}$ 比较:

- AI $< R$: **HBM-bound**, 耗时 $= B_{HBM} / BW_{HBM}$
- AI $\geq R$: **Compute-bound**, 耗时 $= \text{FLOPs} / F_{MXU}$
