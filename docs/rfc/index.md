...
| [0022](./0022-cleanup-sync-project-e2e-reports.md) | 清理 sync_project 并端到端验证日/周报有效性 | draft | @sii-xinglong | 2026-04-29 |
| [0023](./0023-align-maxtext-muon-optimizer-megatron.md) | 对齐 MaxText Muon 优化器实现与 Megatron-LM 完整行为 | draft | @sii-xinglong | 2026-04-30 |
| [0024](./0024-import-kernel-benchmark-llo.md) | 支持导入 Kernel 并自动化 Benchmark 与 LLO 下载 | draft | @sii-xinglong | 2026-04-30 |
| [0025](./0025-attention-varlen-loss-alignment.md) | 支持 Attention Varlen 功能并对齐 Loss | draft | @sii-xinglong | 2026-05-02 |
