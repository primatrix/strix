...
Ported from sglang-jax/python/sgl_jax/srt/kernels/fused_moe/v2/tuned_block_configs.py

Same lookup approach as v1 configs but with v2's simpler
...
from ._fused_moe_v2_impl import FusedMoEBlockConfig
