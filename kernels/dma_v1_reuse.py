"""Double-buffer VMEM load benchmark - Version 1: Descriptor Reuse + JIT

This is the current optimized version with:
- DMA descriptors created once outside loop
...
config = {
    ...
    "tpu_type": "v7x",
    "tpu_topology": "1x1",
    "description": "V1: Descriptor reuse + JIT",
}
