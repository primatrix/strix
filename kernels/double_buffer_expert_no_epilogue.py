"""Ablation: skip last tile compute (epilogue compute removed).

Isolates the cost of the final tile's MXU work. DMA pipeline and
cast+writeback are unchanged.
"""
...
def _double_buffer_expert_kernel(
    ...
    *,
    ...
    # -- Epilogue: drain last tile DMA, skip compute --
    if n_w >= 2:
        last_slot = (n_w - 1) % 2
