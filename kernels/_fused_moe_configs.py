...
Ported from upstream sglang-jax tuning infrastructure (vendored locally).
...
from ._fused_moe_impl import FusedMoEBlockConfig


def get_device_name() -> str:
    """Return the device kind string (e.g. 'TPU v7')."""
...
TUNED_BLOCK_CONFIGS: dict[str, dict[tuple, tuple[int, ...]]] = {
    ...
    "TPU v7": {
        ...
        ('bfloat16', 'float8_e4m3fn', 16, 256, 8, 4096, 2048, 8, False, False): (2, 2048, 2048, 2048, 8, 8, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 32, 256, 8, 4096, 2048, 8, False, False): (4, 2048, 2048, 2048, 8, 8, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 64, 256, 8, 4096, 2048, 8, False, False): (8, 2048, 2048, 2048, 16, 16, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 128, 256, 8, 4096, 2048, 8, False, False): (16, 2048, 2048, 2048, 32, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 256, 256, 8, 4096, 2048, 8, False, False): (32, 2048, 2048, 2048, 64, 64, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 512, 256, 8, 4096, 2048, 8, False, False): (64, 2048, 2048, 2048, 32, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 1024, 256, 8, 4096, 2048, 8, False, False): (64, 2048, 2048, 2048, 32, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 2048, 256, 8, 4096, 2048, 8, False, False): (256, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),
        ('bfloat16', 'float8_e4m3fn', 4096, 256, 8, 4096, 2048, 8, False, False): (256, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),
        ('bfloat16', 'float8_e4m3fn', 8192, 256, 8, 4096, 2048, 8, False, False): (256, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),
        ('bfloat16', 'float8_e4m3fn', 16384, 256, 8, 4096, 2048, 8, False, False): (256, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),

        ('bfloat16', 'float8_e4m3fn', 64, 384, 8, 6144, 2048, 32, False, False): (2, 2048, 2048, 2048, 16, 16, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 128, 384, 8, 6144, 2048, 32, False, False): (4, 2048, 2048, 2048, 32, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 256, 384, 8, 6144, 2048, 32, False, False): (8, 2048, 2048, 2048, 64, 64, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 512, 384, 8, 6144, 2048, 32, False, False): (16, 2048, 2048, 2048, 64, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 1024, 384, 8, 6144, 2048, 32, False, False): (16, 2048, 2048, 2048, 32, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 2048, 384, 8, 6144, 2048, 32, False, False): (64, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),
        ('bfloat16', 'float8_e4m3fn', 4096, 384, 8, 6144, 2048, 32, False, False): (64, 1024, 2048, 2048, 64, 64, 1024, 2048, 2048, 1024),
    ...
    "TPU v6e": {
        ...
        ('bfloat16', 'bfloat16', 256, 256, 8, 4096, 2048, 16, False, False): (16, 2048, 2048, 2048, 256, 256, 2048, 2048, 2048, 2048),
        ('bfloat16', 'bfloat16', 512, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 2048, 2048, 512, 512, 2048, 2048, 2048, 2048),
        ('bfloat16', 'bfloat16', 1024, 256, 8, 4096, 2048, 16, False, False): (64, 2048, 2048, 2048, 512, 512, 2048, 2048, 2048, 2048),
        ('bfloat16', 'bfloat16', 2048, 256, 8, 4096, 2048, 16, False, False): (128, 1024, 4096, 4096, 512, 512, 1024, 4096, 4096, 1024),
        ('bfloat16', 'bfloat16', 4096, 256, 8, 4096, 2048, 16, False, False): (256, 1024, 4096, 4096, 128, 128, 1024, 4096, 4096, 1024),
        ...
        ('bfloat16', 'float8_e4m3fn', 256, 256, 8, 4096, 2048, 16, False, False): (16, 2048, 4096, 4096, 8, 8, 2048, 4096, 4096, 2048),
        ('bfloat16', 'float8_e4m3fn', 512, 256, 8, 4096, 2048, 16, False, False): (32, 2048, 4096, 4096, 16, 16, 2048, 4096, 4096, 2048),
        ('bfloat16', 'float8_e4m3fn', 1024, 256, 8, 4096, 2048, 16, False, False): (64, 2048, 2048, 2048, 32, 32, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 2048, 256, 8, 4096, 2048, 16, False, False): (128, 2048, 1024, 1024, 64, 64, 2048, 1024, 1024, 2048),
        ('bfloat16', 'float8_e4m3fn', 4096, 256, 8, 4096, 2048, 16, False, False): (256, 1024, 2048, 2048, 128, 128, 1024, 2048, 2048, 1024),
        ...
        ('bfloat16', 'float8_e4m3fn', 1024, 384, 8, 6144, 2048, 64, False, False): (16, 2048, 2048, 2048, 64, 64, 2048, 2048, 2048, 2048),
        ('bfloat16', 'float8_e4m3fn', 2048, 384, 8, 6144, 2048, 64, False, False): (32, 2048, 2048, 2048, 64, 32, 2048, 2048, 2048, 2048),
